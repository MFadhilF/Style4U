      ...
      <div className="relative z-10 flex h-full px-8 py-6">
        ...
        <div className="w-1/2 text-Black">
          <h2 className="text-2xl md:text-3xl font-bold leading-snug">
            Dapatkan 5 MYSTERY BOX<br/>Dengan DISKON 5%
          </h2>
          <p className="mt-2 text-sm md:text-base overflow-hidden"
             style={{
               display: '-webkit-box',
               WebkitLineClamp: 3,
          ...
          >
            ...
            tuk dapatkan diskon! <span className="font-bold">HANYA BULAN INI!!</span>
          </p>
        </div>
        ...
        <div className="flex flex-col justify-end">
          <a
            className="text-sm font-medium text-black hover:underline"  onClick={() => navigate("/lebihlanjut")}
          >
            Info Lanjut →
          </a>
        </div>

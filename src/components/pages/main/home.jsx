...
<section className="py-16 px-4 text-center">
  ...
  <div className="flex justify-center items-baseline space-x-2 mb-2 mr-20">
    ...
    <h1 className="text-8xl font-extrabold uppercase font-impact">Thrifting</h1>
  </div>
  {/* modern tetap di bawah */}
  <h1 className="text-8xl font-extrabold uppercase font-impact">Modern</h1>
</section>
...
>
  ...
  <div className="absolute bottom-8 left-0 right-0 overflow-x-auto hide-scrollbar">
    ...
    <div className="flex space-x-8 pl-4 pr-4 items-start font-playfair font-semibold" style={{ width: 'calc(100% + 4rem)' }}>
      {[
        ...
        >
          <img src={p.img} alt={p.title} className="w-38 h-38 object-contain mb-2 pl-2" />
          <h4 className=" flex-row font-semibold text-m">{p.title}</h4>
          <p className="absolute text-[10px] text-gray-500">{p.brand}</p>
...
<div className="flex items-center justify-between mb-8">
  ...
  {/* Tombol kanan */}
  <button className="text-sm bg-yellow-400 text-black px-4 py-2 rounded-full hover:bg-yellow-500 self-end font-roboto font-bold" onClick={() => navigate("/ProductListPage")} >
    Lihat Semua
  </button>
</div>

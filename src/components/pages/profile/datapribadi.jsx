...
export default function DataPribadi() {
  ...
  return (
    <div className={`p-4 sm:p-6 lg:p-8 max-w-6xl md:ml-[260px]`}> {/* Sesuaikan md:ml-[260px] dengan lebar sidebar Anda */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 lg:gap-10">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              <input type="text" id="username" value="Sumbul_Aja" className="w-full border border-gray-300 rounded-md px-3 py-2 shadow-sm focus:ring-lime-500 focus:border-lime-500 text-sm sm:text-base" readOnly />
          ...
          <div>
            ...
            <div className="relative">
              <input type="text" id="namaLengkap" value="Muhammad Sumbul" className="w-full border border-gray-300 rounded-md px-3 py-2 shadow-sm focus:ring-lime-500 focus:border-lime-500 text-sm sm:text-base" readOnly />
              <Pencil className="absolute right-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 cursor-pointer" />
            </div>
          </div>
          <div>
            <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-1">Email</label>
            <input type="email" id="email" value="sumbulji12345@gmail.com" className="w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-100 shadow-sm text-sm sm:text-base" readOnly />
          </div>
          <div>
            <label htmlFor="noHandphone" className="block text-sm font-medium text-gray-700 mb-1">No Handphone</label>
            <input type="tel" id="noHandphone" value="089567441423" className="w-full border border-gray-300 rounded-md px-3 py-2 shadow-sm focus:ring-lime-500 focus:border-lime-500 text-sm sm:text-base" />
          </div>
          ...
          <div>
            ...
            >
              <span className={`text-sm sm:text-base ${selectedGender ? 'text-gray-900' : 'text-gray-500'}`}>
                {selectedGender === 'laki-laki' ? 'Laki - laki' : selectedGender === 'perempuan' ? 'Perempuan' : 'Pilih jenis kelamin'}
              </span>
            ...
            {isGenderDropdownOpen && (
              <div className="relative mt-1 z-10"> {/* z-10 agar muncul di atas elemen lain jika perlu */}
                <ul
                ...
                >
                  {['laki-laki', 'perempuan'].map((genderOption) => (
                    <li
                      key={genderOption}
                      className={`px-3 py-2 cursor-pointer hover:bg-gray-100 ${selectedGender === genderOption ? 'bg-white-50 text-white-700 font-semibold' : 'text-gray-900'}`}
                      onClick={() => {
                    ...
                    >
                      {genderOption === 'laki-laki' ? 'Laki - laki' : 'Perempuan'}
                    </li>
                  ))}
                </ul>
              </div>
          ...
          <h2 className="text-xl sm:text-2xl font-semibold mb-3 text-gray-800">Alamat Saya</h2>

          {/* ... field Alamat Lengkap, Kode Pos, Kota, Provinsi ... */}
          <div>
            <label htmlFor="alamatLengkap" className="block text-sm font-medium text-gray-700 mb-1">Alamat Lengkap</label>
            <div className="relative">
              <input type="text" id="alamatLengkap" value="Jalan Sudirman No.56 , Jambung Kulon, Surabaya, Jawa Timur" className="w-full border border-gray-300 rounded-md px-3 py-2 shadow-sm focus:ring-lime-500 focus:border-lime-500 text-sm sm:text-base" readOnly />
              <Pencil className="absolute right-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 cursor-pointer" />
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div>
              ...
              <input type="text" id="kodePos" value="22341" className="w-full border border-gray-300 rounded-md px-3 py-2 shadow-sm focus:ring-lime-500 focus:border-lime-500 text-sm sm:text-base" />
            </div>
            <div>
              <label htmlFor="kota" className="block text-sm font-medium text-gray-700 mb-1">Kota</label>
              <div className="relative">
                <input type="text" id="kota" value="Surabaya" className="w-full border border-gray-300 rounded-md px-3 py-2 shadow-sm focus:ring-lime-500 focus:border-lime-500 text-sm sm:text-base" readOnly />
                <Pencil className="absolute right-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 cursor-pointer" />
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="relative">
              <input type="text" id="provinsi" value="Jawa Timur" className="w-full border border-gray-300 rounded-md px-3 py-2 shadow-sm focus:ring-lime-500 focus:border-lime-500 text-sm sm:text-base" readOnly />
              <Pencil className="absolute right-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 cursor-pointer" />
            </div>
          </div>
        ...
        <div className="md:col-span-1 flex flex-col items-center text-center md:items-start md:text-left justify-start mt-8 md:mt-0 order-first md:order-last">
           <h2 className="text-base sm:text-lg font-semibold mb-3 text-gray-800">Gambar Profil</h2>
          <div className="relative mb-3">
            ...
            />
            <button aria-label="Ubah foto profil" className="absolute bottom-1 right-1 w-6 h-6 sm:w-7 sm:h-7 text-gray-700 bg-white rounded-full p-1 shadow hover:bg-gray-100 transition-colors flex items-center justify-center">
